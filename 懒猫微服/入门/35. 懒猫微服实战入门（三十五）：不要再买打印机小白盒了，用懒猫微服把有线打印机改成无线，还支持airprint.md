---
title: USB 打印机网络共享：CUPS、AirPrint 与驱动兼容实测
description: 用 CUPS 共享 USB 打印机并连接 AirPrint，记录 USB 直通、驱动不兼容和打印异常，以及 Windows 与 RDP 的备用方案。
tags:
- 懒猫微服
toc: true
series: 懒猫微服入门
...
updated: '2026-09-22 18:44:44'
original_title: 懒猫微服实战入门（三十五）：不要再买打印机小白盒了，用懒猫微服把有线打印机改成无线，还支持 AirPrint
---

旧 USB 打印机能不能变成手机、电脑都能用的网络打印机，关键在于共享服务、USB 设备识别和驱动兼容。本文记录我用 CUPS 与 AirPrint 改造联想打印机的过程，也保留大图片失败、页数异常等实际问题。CUPS 运行在懒猫微服上；遇到驱动障碍时，我又用 Windows 官方驱动和 RDP 做了备用方案。

本文属于「懒猫微服实战入门 · 第三十五篇」。[查看系列目录](/topics/#containers) · [懒猫微服的设备接入与家庭服务](/topics/#lazycat)。
