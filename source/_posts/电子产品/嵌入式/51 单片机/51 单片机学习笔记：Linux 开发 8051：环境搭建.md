---
title: 51 单片机学习笔记：Linux 开发 8051：环境搭建
date: '2017-12-24 12:38:26'
updated: '2017-12-24 12:38:26'
abbrlink: 8bd7b11b
description: 在 Linux 下配置 SDCC 与 stcflash，记录 8051 程序的编译、串口连接和烧录过程。
categories:
- 电子产品
- 嵌入式
- 51 单片机
...
source_url: https://www.jianshu.com/p/9a68e2da79bb
source_title: Linux开发8051(一)    ~    环境搭建
series: 单片机与嵌入式学习笔记
---
