...
description: 配置 GitHub OAuth 实现单点登录到懒猫微服上的 Memos 笔记应用。
tags:
  - 懒猫微服
toc: true
series: 懒猫微服入门
...
之前写过拿 Memos 替代 GitHub 记东西，这次往前走一步：给 Memos 挂上 GitHub 单点登录，省掉一套独立密码。你自己开发的应用想接 GitHub，走的也是这条路。
