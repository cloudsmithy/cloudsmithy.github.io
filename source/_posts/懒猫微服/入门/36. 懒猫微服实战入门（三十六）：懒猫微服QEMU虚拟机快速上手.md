...
description: 在懒猫微服上使用 QEMU 虚拟机，全容器化安装免去环境依赖烦恼，轻松上手虚拟机操作。
tags:
  - 懒猫微服
toc: true
series: 懒猫微服入门
...
![image-20260226215103173](https://raw.githubusercontent.com/cloudsmithy/picgo-imh/master/image-20260226215103173.png)

和其他虚拟机一样，我们需要一个 ISO 镜像。QEMU 厉害的地方在于它对镜像来源几乎从不挑剔

可以直接填入官网的 ISO 下载链接，边下边装，省去中间转手的麻烦。

![image-20260226215121062](https://raw.githubusercontent.com/cloudsmithy/picgo-imh/master/image-20260226215121062.png)
...
![image-20260226215417448](https://raw.githubusercontent.com/cloudsmithy/picgo-imh/master/image-20260226215417448.png)
...
当然也可以安装**安卓系统**，我尝试运行了BlissOS，很流畅，除了必要的X86和ARM指令集转换缺失之外，其他的都可以流程运行。甚至把虚拟机内部的 **5555 端口**（ADB 默认调试端口）通过端口映射的工具映射出来。这样，我们在局域网内的任何一台电脑上，只需要执行这个命令就可以进行ADB调试：
...
![image-20260226214930363](https://raw.githubusercontent.com/cloudsmithy/picgo-imh/master/image-20260226214930363.png)

安装完成之后，完全不用担心远程连接的问题，甚至还自带一个web的no-VNC。

![image-20260226220427413](https://raw.githubusercontent.com/cloudsmithy/picgo-imh/master/image-20260226220427413.png)
