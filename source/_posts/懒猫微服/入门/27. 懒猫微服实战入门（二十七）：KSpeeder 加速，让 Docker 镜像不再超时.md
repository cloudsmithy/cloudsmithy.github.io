...
description: 用 KSpeeder 加速懒猫微服上的 Docker 镜像拉取，告别超时问题。
tags:
  - 懒猫微服
toc: true
series: 懒猫微服入门
...
国内拉 Docker 镜像超时这事已经是常态了。我收藏夹里存过好几个第三方加速地址，能用的窗口期一般也就几个月，到点就静悄悄地失效，然后又得重新去找一个。

后来发现懒猫商店里有 **KSpeeder**，一键装上，再借懒猫自带的端口转发和内网穿透往外一暴露，就不用再养那张收藏夹清单了。

### 为什么选择懒猫微服

换个环境自己部署 KSpeeder，一般要做这几件事：
