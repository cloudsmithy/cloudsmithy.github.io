...
- 首页专题气泡错开节奏漂浮，并带柔和高光；悬停或键盘聚焦时暂停，遵循系统“减少动态效果”，手机上可横向滚动。`home_title` 可设置短名称，专题页继续显示完整名称和阅读路线。
...
- 顶部“技术专题 / 文章归档 / 生活”悬停立即展开，移出后保留 3 秒，移回标题或下拉菜单会取消收起；点击标题进入对应总览页，点击菜单外部或按 Esc 可立即收起。手机侧栏支持点击展开，键盘可用 Enter / Esc 操作。书单与课程、个人语录放在“生活”下。
